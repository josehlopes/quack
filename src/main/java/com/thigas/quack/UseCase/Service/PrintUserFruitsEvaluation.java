...
@Service
public class PrintUserFruitsEvaluation implements ActivityEvaluation {
    ...
    public String evaluate(String code) {
        try {
            ...
            if (!result.isEmpty()) {
                return "Parabéns! O código executou corretamente e imprimiu as frutas: " + result;
            } else {
                return "O código executou, mas a saída está incorreta. Certifique-se de imprimir corretamente os nomes das frutas.";
            }
